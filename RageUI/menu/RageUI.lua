...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 390, Height = 105 },
            Text = { X = 211, Y = 12, Scale = 0.8 },
        },
        Subtitle = {
            Background = { Width = 390, Height = 40 },
            Text = { X = 14, Y = 5, Scale = 0.25 },
            PreText = { X = 375, Y = 5, Scale = 0.25 },
        },
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 10, Width = 390 },
        Navigation = {
        ...
        Description = {
            Bar = { Y = 20, Width = 390, Height = 4 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 20, Width = 390, Height = 30 },
            Text = { X = 8, Y = 25, Scale = 0.25 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 390, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 390, Height = 76 },
        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            for i = 0, segments - 1 do
                ...
                RenderRectangle(
                    ...
                    segmentHeight, 
                    math.floor(intensity * Configk2rUI.Menu.DegraderBanniere.R * 0.2),
                    math.floor(intensity * Configk2rUI.Menu.DegraderBanniere.G * 0.2),
                    math.floor(intensity * Configk2rUI.Menu.DegraderBanniere.B * 0.2),
                    alpha
                )
            end
...
function RageUI.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            RenderRectangle(CurrentMenu.X, 146 + CurrentMenu.Y + RageUI.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUI.ItemOffset - 117, 0, 0, 0, 135)
...
function RageUI.IsVisible(Menu, Items, Panels)
    if (RageUI.Visible(Menu)) and (UpdateOnscreenKeyboard() ~= 0) and (UpdateOnscreenKeyboard() ~= 3) then
        RageUI.CurrentMenu.X = GetResourceKvpInt('MENU_ALIGNMENT') == 1 and 1420 or -20 or 0
